...
sensorfw_proxy::core::Sensorfw::Sensorfw(
...
const char* sensorfw_proxy::core::Sensorfw::plugin_string() const
{
    switch (m_plugin) {
...
const char* sensorfw_proxy::core::Sensorfw::plugin_interface() const
{
    switch (m_plugin) {
...
const char* sensorfw_proxy::core::Sensorfw::plugin_path() const
{
    if (!m_pluginPath)
        return "";
...
bool sensorfw_proxy::core::Sensorfw::load_plugin()
{
...
void sensorfw_proxy::core::Sensorfw::request_sensor()
{
...
bool sensorfw_proxy::core::Sensorfw::release_sensor()
{
...
gboolean sensorfw_proxy::core::Sensorfw::static_data_recieved(GSocket * /* socket */, GIOCondition cond, gpointer user_data)
{
    if (! (cond & G_IO_IN))
...
void sensorfw_proxy::core::Sensorfw::start()
{
    if (m_gsource)
        return;
...
void sensorfw_proxy::core::Sensorfw::stop()
{
    if (!m_gsource)
        return;
...
void sensorfw_proxy::core::Sensorfw::set_interval(int interval) {
    int constexpr timeout_default = 1000;
    auto const result =  g_dbus_connection_call_sync(
            dbus_connection,
            dbus_sensorfw_name,
