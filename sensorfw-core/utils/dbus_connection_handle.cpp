...
sensorfw_proxy::core::DBusConnectionHandle::DBusConnectionHandle(std::string const& address)
{
    GError *error = NULL;
...
sensorfw_proxy::core::DBusConnectionHandle::~DBusConnectionHandle()
{
    g_dbus_connection_close_sync(connection, nullptr, nullptr);
}

void sensorfw_proxy::core::DBusConnectionHandle::request_name(char const* name) const
{
...
sensorfw_proxy::core::DBusConnectionHandle::operator GDBusConnection*() const
{
    return connection;
}
