...
sensorfw_proxy::core::EventLoop::EventLoop(std::string const& name)
...
sensorfw_proxy::core::EventLoop::~EventLoop()
{
    stop();
}

void sensorfw_proxy::core::EventLoop::stop()
{
    if (main_loop)
...
std::future<void> sensorfw_proxy::core::EventLoop::enqueue(std::function<void()> const& callback)
{
...
std::future<void> sensorfw_proxy::core::EventLoop::schedule_in(
...
void sensorfw_proxy::core::EventLoop::schedule_with_cancellation_in(
    std::chrono::milliseconds timeout,
    std::function<void()> const& callback,
...
void sensorfw_proxy::core::EventLoop::watch_fd(
